...
<html>
	...
	<body>
		...
		<div id="query_area">
			<form action="<%=request.getContextPath() %>/user/list.jhtml">
			...
			<table class="listable" cellspacing="0" cellpadding="0" border="0">
				...
				<c:forEach var="user" items="${page.content}">
					<tr>
						...
						<td>
							<a href="<%=request.getContextPath()%>/user/${user.userId}.jhtml">修改</a>
	...
	<script type="text/javascript">
	    ...
	    function remove(name,id)
        {
          if(confirm("真的要注销用户[" + name + "]吗？"))
             location.href="<%=request.getContextPath() %>/user/delete.jhtml?userId="+id;         
        }
